...
* @param given_nonzero_indices	非0の既知のu値が入るインデックス
* @param given_nonzero_values	非0の既知のu値
*/
void ex21(cv::Mat_<double>& C, int N, std::vector<int>& given_indices, std::vector<double>& given_values, std::vector<int>& given_nonzero_indices, std::vector<double>& given_nonzero_values) {
...
* @param given_nonzero_values	非0の既知のu値
*/
void ex22(cv::Mat_<double>& C, int N, std::vector<int>& given_indices, std::vector<double>& given_values, std::vector<int>& given_nonzero_indices, std::vector<double>& given_nonzero_values) {
	C = cv::Mat_<double>(N + 1, 1, 0.0);
	C(2, 0) = 1.0;
...
* @param given_nonzero_values	非0の既知のu値
*/
void ex23(cv::Mat_<double>& C, int N, std::vector<int>& given_indices, std::vector<double>& given_values, std::vector<int>& given_nonzero_indices, std::vector<double>& given_nonzero_values) {
	C = cv::Mat_<double>(N + 1, 1, 0.0);
	...
	given_nonzero_indices.push_back(2);
	given_nonzero_values.push_back(1);
}
...
int main() {
	...
	//ex21(C, N, given_indices, given_values, given_nonzero_indices, given_nonzero_values);
	ex22(C, N, given_indices, given_values, given_nonzero_indices, given_nonzero_values);
	//ex23(C, N, given_indices, given_values, given_nonzero_indices, given_nonzero_values);
	std::cout << "C:" << std::endl << C << std::endl;

	bound2(A, C, given_indices, given_nonzero_indices, given_nonzero_values);
	std::cout << "A:" << std::endl << A << std::endl;
